    ...
    async handle(req: Request, res: Response) {
        try {
            ...
            const mailOptions = {
                ...
                html: "<p>Seu código de recuperação de senha é <b>" + code + "</b>.<br><br>Se você <b>não</b> solicitou recuperação de senha, por favor <b>não repasse</b> esse código a ningém!<br><br><b>Este é um email automático, por favor não responda.<b/>"
            };
            ...
            await transporter.sendMail(mailOptions, function(error: Error) {
                if (error) {
                    ...
                    return res.cookie('recovery_code', hashedCode, {
                        httpOnly: true,
